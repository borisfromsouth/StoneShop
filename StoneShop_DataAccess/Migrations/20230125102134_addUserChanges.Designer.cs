...
namespace StoneShop_DataAccess
{
    ...
    [Migration("20230125102134_addUserChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoneShop_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneShop_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneShop_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneShop_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneShop_Models.InquiryDetail", b =>
                {
                    b.HasOne("StoneShop_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoneShop_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("StoneShop_Models.InquiryHeader", b =>
                {
                    b.HasOne("StoneShop_Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("StoneShop_Models.OrderDetail", b =>
                {
                    b.HasOne("StoneShop_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("StoneShop_Models.OrderHeader", b =>
                {
                    b.HasOne("StoneShop_Models.User", "CreatedBy")
                        .WithMany()
